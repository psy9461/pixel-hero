...
typedef void (*MethodEb)(HWND hwnd);
HWND createWndEditBox(const char* str, int x, int y, int width, int height, WndEditStyle style, MethodEb method = NULL);
HWND createWndEditBoxMultiline(const char* str, int x, int y, int width, int height, MethodEb method = NULL);

typedef void (*METHOD_OPENGL)();
